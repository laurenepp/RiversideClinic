...
ALTER TABLE Patient
  ADD COLUMN Address_Line1 VARCHAR(255) NULL AFTER Email,
...
ALTER TABLE Insurance_Info
  ADD COLUMN Policy_Number VARCHAR(128) NULL AFTER Insurance_Provider,
  ADD COLUMN Policy_Holder VARCHAR(255) NULL AFTER Policy_Number,
  ADD COLUMN Updated_At DATETIME NOT NULL DEFAULT CURRENT_TIMESTAMP
    ON UPDATE CURRENT_TIMESTAMP AFTER Date_Sent;
